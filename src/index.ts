...
const サークルブロック一覧: { ブロック名: string, ブロック名の種類: "アルファベット" | "平仮名" | "片仮名", ホールの場所: "東123" | "東456" | "西", 存在しない日: number[], 表で後に入れる?: "スペース" | "改行", チェックエレメント?: HTMLInputElement, ラベルエレメント?: HTMLLabelElement }[] = [
  ...
  { ブロック名: "め", ブロック名の種類: "アルファベット", ホールの場所: "西", 存在しない日: [], 表で後に入れる: undefined },
  { ブロック名: "も", ブロック名の種類: "アルファベット", ホールの場所: "西", 存在しない日: [], 表で後に入れる: "スペース" },
  { ブロック名: "や", ブロック名の種類: "アルファベット", ホールの場所: "西", 存在しない日: [], 表で後に入れる: "スペース" },
  { ブロック名: "ゆ", ブロック名の種類: "アルファベット", ホールの場所: "西", 存在しない日: [], 表で後に入れる: "スペース" },
  { ブロック名: "よ", ブロック名の種類: "アルファベット", ホールの場所: "西", 存在しない日: [], 表で後に入れる: "改行" },
  { ブロック名: "ら", ブロック名の種類: "アルファベット", ホールの場所: "西", 存在しない日: [], 表で後に入れる: undefined },
  { ブロック名: "り", ブロック名の種類: "アルファベット", ホールの場所: "西", 存在しない日: [], 表で後に入れる: undefined },
  { ブロック名: "る", ブロック名の種類: "アルファベット", ホールの場所: "西", 存在しない日: [], 表で後に入れる: undefined },
  { ブロック名: "れ", ブロック名の種類: "アルファベット", ホールの場所: "西", 存在しない日: [], 表で後に入れる: undefined },
  { ブロック名: "ろ", ブロック名の種類: "アルファベット", ホールの場所: "西", 存在しない日: [], 表で後に入れる: undefined },
];
